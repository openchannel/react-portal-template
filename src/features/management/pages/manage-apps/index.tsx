...
import { ChartOptionsChange, OcChartComponent } from '@openchannel/react-common-components/dist/ui/portal/organisms';
  ...
  return (
    <MainTemplate>
      <div className="bg-container height-unset manage-app-header">
          <OcNavigationBreadcrumbs pageTitle="Manage apps" buttonText="Create app" buttonClick={() => onClickPass()} />
      </div>
